...
Having said that, if given the chance I'd still encourage more developers working on Java server-side to give Kotlin a try. If nothing else, it may highlight other areas of improvement beyond the code.
